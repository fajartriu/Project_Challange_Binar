package Challenge_7BinarFood.Invoice.repository.order;

import Challenge_7BinarFood.Invoice.model.order.OrderDetail;
...
//
    @Query("select new Challenge_7BinarFood.Invoice.DTO.InvoiceOrder(o.id, o.order_time, u.userName, p.productName, " +
            "m.merchantName, o.destination_address, od.quantity, p.price, od.total_price, o.completed) from User u " +
            "JOIN u.order o JOIN o.orderDetail od JOIN od.product p JOIN p.merchant m where u.id=:userId")
