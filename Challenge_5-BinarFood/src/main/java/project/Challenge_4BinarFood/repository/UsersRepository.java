...
public interface UsersRepository extends JpaRepository<Users, UUID> {
    ...
    void createUsers(@Param("id") UUID id, @Param("username") String username, @Param("emailAdress")
    String emailAdress, @Param("password") String password);
    ...
    void updateUser(@Param("id") UUID id, @Param("username") String username, @Param("emailAdress") String emailAdress,
